...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR+'/logosdb',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = BASE_DIR+'/Logos/media/'
...
SECRET_KEY = '=ma+3ta)!aocq5!^j8c5byhhju(ev%g+ht88&n*!6h#k=dt0v('
